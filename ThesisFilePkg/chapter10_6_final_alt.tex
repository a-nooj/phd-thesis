...
They should instead expose these factors through interfaces that allow planners, optimizers, simulators, and learned models to share responsibility for physical admissibility, enabling robots to move more fluidly across the diverse interaction modes that manipulation in the physical world requires.
