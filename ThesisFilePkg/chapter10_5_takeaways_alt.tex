...
The results in \cref{ch,ch,ch} show that when the planner or generator accounts for these constraints, the robot can demonstrate capabilities that would otherwise be excluded from the feasible motion space.
